...
export const Route = createFileRoute("/")({ head: () => meta("Seguros con nombre y apellido", "Tu agencia de seguros en Bellpuig, Lleida. Más de 30 años asesorando a familias, autónomos y empresas con cercanía y transparencia."), component: Index });
